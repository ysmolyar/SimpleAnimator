...
public class InteractiveViewTest {
  ...
  InteractiveGuiView interactiveGuiView;
  ...
  public void testBasicShapesSVG() {
    ...
    interactiveGuiView = new InteractiveGuiView(10, output);
    interactiveGuiView.updateContents(testModelBuilder.getListOfAnimatedShapes());
    interactiveGuiView.display();
  ...
  public void testSmallDemo() {
    ...
    view = new InteractiveGuiView(10, output);
    ((InteractiveGuiView) view).updateContents(model.getListOfAnimatedShapes());
    view.display();
    assertEquals(output.toString(), "");
